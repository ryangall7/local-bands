    ...
    <section className="relative">
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-17 md:py-28">
          ...
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center sm:pb-12 md:pb-10 md:mb-10 bg-gray-100 rounded shadow-xl">
            <h2 className="h2 mb-4">How do I get my Local Band?</h2>
            <div className="md:flex gap-8 m-4 items-center ">
              <Image src={POSImage} className="w-56 m-4 rounded border-gray-200 mx-auto" alt="Local Bands" />
